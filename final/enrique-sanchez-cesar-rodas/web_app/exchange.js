...
const exchange_name = "Exchange"; // TODO: fill in the name of your exchange

const token_name = "TOKEN"; // TODO: replace with name of your token
const token_symbol = "TKN"; // TODO: replace with symbol for your token
...
async function addLiquidity(amountEth, maxSlippagePct) {
  const ethValue = ethers.utils.parseEther(amountEth);
  poolState = await getPoolState();
  const tokenAmount = Math.ceil(amountEth * poolState.token_eth_rate);
  await token_contract
    .connect(provider.getSigner(defaultAccount))
...
async function swapETHForTokens(amountEth, maxSlippagePct) {
  ...
  await exchange_contract
    .connect(provider.getSigner(defaultAccount))
    .swapETHForTokens({ value: ethValue });
}
