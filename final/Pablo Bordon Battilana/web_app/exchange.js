...
const token_symbol = 'MYT';              // TODO: replace with symbol for your token
...
async function removeLiquidity(amountEth, maxSlippagePct) {
  await exchange_contract.connect(provider.getSigner(defaultAccount)).removeLiquidity(ethers.utils.parseEther(amountEth));
}
