...
var formater = ethers.utils.parseEther
//from splitwisejson import '../artifacts/contracts/mycontract.sol/Splitwise.json' assert {type:"json"}
...
async function getStore() {
	return BlockchainSplitwise.get()
}

// TODO: Get the total amount owed by the user specified by 'user'
async function getTotalOwed(user) {
	return await BlockchainSplitwise.getTotalOwed(user)
...
async function add_IOU(acreedor, monto, deudor) {
	await BlockchainSplitwise.add_IOU(acreedor, monto, deudor)
}
